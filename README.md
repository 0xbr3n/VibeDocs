...
<div align="center">
<img src="docs/screenshots/01-dashboard.png" alt="VibeDocs dashboard" width="80%">
</div>
...
4. **Add findings** — from the library, manually, or by importing a scan.
   <div align="center"><img src="docs/screenshots/add-finding.png" alt="Adding a finding" width="80%"></div>
...
6. **Generate** a DRAFT for review, then the clean FINAL — as Word, PDF, or an encrypted ZIP.
   <div align="center"><img src="docs/screenshots/06-word-output.png" alt="Generated Word report" width="80%"></div>
